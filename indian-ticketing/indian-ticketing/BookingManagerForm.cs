...
public class BookingManagerForm : Form
{
    ...
    private void BuildUi()
    {
        ...
        _btnStartAll.Location  = new Point(548, 10);
        ...
        _btnRefresh.Location  = new Point(686, 10);
        ...
        _topBar.Controls.AddRange(new Control[] {
            _lblTitle, _lblUser, _txtUser, _lblPass, _txtPass, _btnStartAll, _btnRefresh
        });
...
public class BookingCard : Panel
{
    ...
    public BookingCard(SavedBooking b)
    {
        ...
        Controls.AddRange(new Control[] { _lblTrain, _lblPax, _lblStatus, _btnBook, _btnAck, _btnDel, _picQr });
    }
